...
\textbf{Total points.} Book exercises: 15; Lab exercises 7; Overall: 22.
...
\item (Slight variation of Hoff 2.1) The social mobility data from Section 2.5 in Hoff gives a joint probability distribution on $(Y_1,Y_2) =$ (father's occupation, son's occupation). Using this joint distribution, calculate the following distributions:

\vspace*{1em}

\begin{enumerate}[label=(\alph*), leftmargin=1em, itemsep=1em]
\item (1 point) The marginal probability that the father is in sales.
%\item (1 point) The marginal probability that the son is in sales.
\item (1 point) The probability that the son is a farmer, given that the father is in sales.
\item (1 point) The probability that the father is a farmer, given that the son is in sales.
\end{enumerate}
